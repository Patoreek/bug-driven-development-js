// BUG: This rate limiter trusts the X-Forwarded-For header from any client,
// allowing trivial bypass via header spoofing.
...
export class RateLimiter {
  ...
  // BUG: Blindly trusts X-Forwarded-For without checking if the request
