...
Exercise platform where users fix buggy/suboptimal TypeScript + Next.js code. 130 exercises across frontend, backend, fullstack, typescript, testing, javascript, and leetcode categories.
...
- `fe-` frontend, `be-` backend, `fs-` fullstack, `ts-` typescript, `test-` testing, `js-` javascript, `lc-` leetcode
